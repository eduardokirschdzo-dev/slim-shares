...
interface ProfileClientProps {
  ...
  /** true apenas quando quem está vendo a página está logado E é o dono deste perfil */
  isOwner: boolean;
}

export default function ProfileClient({ initialProfile, analytics, isOwner }: ProfileClientProps) {
      ...
      {isOwner && (
        <div className="absolute top-6 right-6 flex items-center gap-2 z-20">
          <button
            ...
            className="p-3 bg-[#111] border border-[#333] text-gray-400 hover:text-yellow-500 rounded-full shadow-lg transition-colors"
            title="Editar perfil"
          >
          ...
          <button
            ...
            className="p-3 bg-[#111] border border-[#333] text-gray-400 hover:text-red-400 rounded-full shadow-lg transition-colors"
            title="Sair da conta"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
          </button>
        </div>
      )}
