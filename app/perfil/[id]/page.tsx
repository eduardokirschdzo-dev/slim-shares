    ...
    <main className="min-h-screen bg-[#000000] text-white flex flex-col items-center py-10 px-6 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 flex flex-col items-center mt-8">
        {!isEditing ? (
          <>
            ...
            <div className="w-full space-y-3 mt-4">
              {[
                ...
                <a key={i} href={btn.href} target="_blank" className="flex items-center gap-4 w-full px-6 py-4 bg-[#111111] hover:bg-[#1a1a1a] border border-[#222] text-gray-200 font-medium rounded-2xl transition-all shadow-sm">
                  <svg className="w-6 h-6 fill-current text-white" viewBox="0 0 24 24">{btn.icon}</svg>
                  {btn.label}
                </a>
              ))}
              ...
              {perfil.links_extras?.map((link: any, index: number) => (
                <a key={index} href={link.url} target="_blank" className="flex items-center gap-4 w-full px-6 py-4 bg-[#111111] hover:bg-[#1a1a1a] border border-[#222] text-gray-200 font-medium rounded-2xl transition-all shadow-sm">
                  <svg className="w-6 h-6 fill-current text-white" viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  {link.title}
                </a>
              ))}
            </div>
            ...
            <div className="w-full mt-8 bg-[#0a0a0a] border border-yellow-600/30 rounded-3xl p-5 shadow-[0_0_20px_rgba(202,138,4,0.05)] relative overflow-hidden">
              {/* Background gradient for chart glow */}
              ...
              {/* Linha do Gráfico SVG (Simulando o efeito da imagem) */}
          ...
          <div className="w-full bg-[#0a0a0a] p-6 rounded-3xl border border-[#222] text-left space-y-4 shadow-xl">
